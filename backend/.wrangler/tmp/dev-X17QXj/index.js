  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\SAI VARA PRASAD\\OneDrive\\Desktop\\med\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// node_modules/@sai48/medium-validate2/dist/index.js
var require_dist = __commonJS({
  "node_modules/@sai48/medium-validate2/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// src/routes/user.ts
var import_medium_validate2 = __toESM(require_dist());
var userRouter = new Hono2();
userRouter.post("/signup", async (c) => {
  const body = await c.req.json();
  const { success } = import_medium_validate2.signupInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
...
userRouter.post("/signin", async (c) => {
  const body = await c.req.json();
  const { success } = import_medium_validate2.signinInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
      message: "Inputs not correct"
...
var import_medium_validate22 = __toESM(require_dist());
...
blogRouter.post("/", async (c) => {
  const body = await c.req.json();
  const { success } = import_medium_validate22.createPostInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
      message: "Inputs not correct"
